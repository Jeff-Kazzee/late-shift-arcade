// The canonical quantized command stream (D3/D5).
//
...
export const CMD = Object.freeze({ MOVE: 0, MINE: 1, PLACE: 2, ATTACK: 3, BANK: 4 });
...
export function encodeCommand(cmd) {
  switch (cmd.type) {
    ...
    case CMD.MINE:
      return [cmd.t, cmd.p, cmd.s, CMD.MINE, cmd.x, cmd.y, cmd.z, 0];
    case CMD.PLACE:
